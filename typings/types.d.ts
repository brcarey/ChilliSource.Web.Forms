...
/** Types */
export type InputType = 'text' | 'radio' | 'checkbox' | 'number' | 'email' | 'password' | 'hidden' | 'file';
...
export interface CommonDateProps extends BaseReactProps, NameProp, DateWrapperProps, OnChangeEventProps<DateRangeMoment | Moment>, AdditionalCompareProps {
  date?: Moment,
  dateFormat?: string,
...
export interface PerformanceWrapperWithProps extends InputInfoProps, DefaultValueProp<PossibleInputValue> {
  inputPath: string[]
}

export interface PerformanceWrapperProps extends PerformanceWrapperWithProps, PerformanceWrapperWithHandlers, FormContext {}

export interface WithHandlersGuard extends NameProp, IdProp, TypeProp, DefaultSwitchProps, DefaultValueProp<PossibleInputValue>, NameProp, BaseReactProps, ValueProp<PossibleInputValue>, IdProp, TypeProp {}